...
<head>
    ...
    <style>
        ...
        /* Estilo para o botão de logar quando o formulário estiver preenchido */
        .btn-filled {
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form id="loginForm" action="login.php" method="POST">
                                        ...
                                        <button id="loginBtn" type="submit" class="btn btn-dark btn-lg btn-block">LOGAR</button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function checkFields() {
            ...
            if (cpf.trim() !== "" && senha.trim() !== "") {
                // Se ambos os campos estiverem preenchidos, adiciona a classe ao botão de logar
                loginBtn.classList.add("btn-filled");
            } else {
                // Se algum campo estiver vazio, remove a classe do botão de logar
                loginBtn.classList.remove("btn-filled");
            }
        }

        // Event listener para verificar os campos quando houver uma mudança nos inputs
