...
<body>
    ...
    <section class="py-5">
        <div class="containerrr">
            ...
            <img src="../img/<?php echo $_SESSION['imagem']?>" height="180px" width="160px" >
        </div>
    </section>
